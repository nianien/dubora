...
from dubora_core.infra.tts_client import call_volcengine_tts as _call_volcengine_tts

router = APIRouter()

from dubora_core.config.settings import get_voice_preview_cache_dir
from dubora_core.resources import get_resource_path

_VOICES_PATH = get_resource_path("voices.json")
_CACHE_DIR = get_voice_preview_cache_dir()
